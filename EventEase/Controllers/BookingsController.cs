...
namespace EventEase.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookingID,VenueID,EventID,StartDate,EndDate")] Booking booking)
        {
            ...
            {
                var isBooked = _context.Bookings.Any(b => b.VenueID == booking.VenueID && ((booking.StartDate >=b.StartDate && booking.StartDate <b.EndDate) || (booking.EndDate > b.StartDate && booking.EndDate <= b.EndDate)));
                if (isBooked)
                {
